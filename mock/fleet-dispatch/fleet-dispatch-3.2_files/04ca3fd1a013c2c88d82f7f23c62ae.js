...
Marketplace.prototype.updateToken = function () {
...
Marketplace.prototype.onClickBuyingItem = function (e) {
  ...
  this.submitAcceptBuying(marketItemId)
}
...
Marketplace.prototype.submitAcceptBuying = function (marketItemId) {
  let params = {marketItemId: marketItemId}
...
Marketplace.prototype.onClickSellingItem = function (e) {
  e.preventDefault()
  let marketItemId = $(e.currentTarget).data('itemid')
  this.submitAcceptSelling(marketItemId)
}
...
Marketplace.prototype.submitAcceptSelling = function (marketItemId) {
  let params = {marketItemId: marketItemId}
...
Marketplace.prototype.onClickDeleteItem = function (e) {
  ...
  errorBoxDecision(
    ...
    function () {
      $.post(urlDelete,that.handleSubmitDeleteResponse.bind(that))
...
Marketplace.prototype.onClickCollectItem = function(e) {
  ...
  this.submitCollectItem(marketTransactionId)
}

Marketplace.prototype.submitCollectItem = function (marketTransactionId) {
  let params = {marketTransactionId: marketTransactionId}
...
Marketplace.prototype.onClickCollectPrice = function(e) {
  e.preventDefault()
  let marketTransactionId = $(e.currentTarget).data('transactionid')
  this.submitCollectPrice(marketTransactionId)
}

Marketplace.prototype.submitCollectPrice = function (marketTransactionId) {
  let params = {marketTransactionId: marketTransactionId}
...
Marketplace.prototype.onSortChangeHistoryBuying = function () {
  this.fetchHistoryBuyingItems()
}
...
Marketplace.prototype.onSortChangeHistorySelling = function () {
  this.fetchHistorySellingItems()
}
...
Marketplace.prototype.initTabCreateOffer = function (cfg) {
  ...
  this.MARKET_ITEM_TYPE_SELL_REQUEST = cfg.marketItemTypes.SELL_REQUEST
  this.MARKET_ITEM_TYPE_BUY_REQUEST = cfg.marketItemTypes.BUY_REQUEST
...
Marketplace.prototype.refreshAvailableItemTypes = function () {
    ...
    if (this.MARKET_ITEM_TYPE_SELL_REQUEST === this.marketItemType || this.MARKET_ITEM_TYPE_SELL_ORDER === this.marketItemType) {
        if(itemOptions.length == 0) {
            this.btnOptShips.attr('disabled', 'disabled')
            $("label[for='btnOptShips']").addClass('disabled')
        }
    } else if(this.MARKET_ITEM_TYPE_BUY_REQUEST === this.marketItemType || this.MARKET_ITEM_TYPE_BUY_ORDER === this.marketItemType){
...
Marketplace.prototype.refreshMarketItemTypes = function () {
  this.btnOptSellRequest.prop('checked', this.marketItemType === this.MARKET_ITEM_TYPE_SELL_REQUEST)
  this.btnOptBuyRequest.prop('checked', this.marketItemType === this.MARKET_ITEM_TYPE_BUY_REQUEST)
...
Marketplace.prototype.refreshItemIdOptions = function () {
  ...
  if (this.ITEM_TYPE_SHIP === this.itemType
      && (this.MARKET_ITEM_TYPE_SELL_REQUEST === this.marketItemType || this.MARKET_ITEM_TYPE_SELL_ORDER === this.marketItemType)) {
  ...
  if (this.ITEM_TYPE_SHIP === this.itemType
      && (this.MARKET_ITEM_TYPE_BUY_REQUEST === this.marketItemType || this.MARKET_ITEM_TYPE_BUY_ORDER === this.marketItemType)) {
      this.itemOptions.ships.forEach(function (option) {
          htmlOptions += '<option value="' + option.value + '">' + option.name + '</option>'
      })
  }
...
Marketplace.prototype.isBuying = function () {
  return this.marketItemType === this.MARKET_ITEM_TYPE_BUY_ORDER || this.marketItemType === this.MARKET_ITEM_TYPE_BUY_REQUEST
}

Marketplace.prototype.isSelling = function () {
  return this.marketItemType === this.MARKET_ITEM_TYPE_SELL_ORDER || this.marketItemType === this.MARKET_ITEM_TYPE_SELL_REQUEST
}
